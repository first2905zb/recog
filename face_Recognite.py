...
python train.py --workers 8 --device 0 --batch-size 8 --data data/custom.yaml --img 640 640 --cfg cfg/training/yolov7-custom.yaml --weights 'yolov7.pt' --name test000 --hyp data/hyp.scratch.custom.yaml --epoch 100